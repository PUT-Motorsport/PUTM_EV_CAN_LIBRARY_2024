...
const CAN_TxHeaderTypeDef can_tx_header_STEERING_WHEEL_MAIN{
    STEERING_WHEEL_MAIN_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    STEERING_WHEEL_MAIN_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_STEERING_WHEEL_EVENT{
    STEERING_WHEEL_EVENT_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    STEERING_WHEEL_EVENT_CAN_DLC, DISABLE};
