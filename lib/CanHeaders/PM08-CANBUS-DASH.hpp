...
struct __attribute__((packed)) Dash_steering_wheel_angle {
  uint16_t steering_wheel_angle;   // Steering wheel angle [0-360] expressed in
                                   // 11 bits [0-4096]
};
...
const uint8_t DASH_SMART_FUSES_FAN_SPEED_CAN_DLC =
    sizeof(Dash_Smart_Fuses_FAN_speed);
const uint8_t DASH_SMART_FUSES_FAN_SPEED_FREQUENCY = 0;
const uint16_t DASH_STEERING_WHEEL_REQUEST_CAN_ID = 0x37;
const uint8_t DASH_STEERING_WHEEL_REQUEST_CAN_DLC =
...
const uint8_t DASH_STEERING_WHEEL_ANGLE_CAN_DLC =
    sizeof(Dash_steering_wheel_angle);
...
const CAN_TxHeaderTypeDef can_tx_header_DASH_MAIN{
    DASH_MAIN_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    DASH_MAIN_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_DASH_TCS{DASH_TCS_CAN_ID,  0xFFF,
                                                 CAN_ID_STD,       CAN_RTR_DATA,
                                                 DASH_TCS_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_DASH_SMART_FUSES_FAN_SPEED{
    DASH_SMART_FUSES_FAN_SPEED_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    DASH_SMART_FUSES_FAN_SPEED_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_DASH_STEERING_WHEEL_REQUEST{
    DASH_STEERING_WHEEL_REQUEST_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    DASH_STEERING_WHEEL_REQUEST_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_DASH_LAP_FINISHED{
    DASH_LAP_FINISHED_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    DASH_LAP_FINISHED_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_DASH_STEERING_WHEEL_ANGLE{
    DASH_STEERING_WHEEL_ANGLE_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    DASH_STEERING_WHEEL_ANGLE_CAN_DLC, DISABLE};
