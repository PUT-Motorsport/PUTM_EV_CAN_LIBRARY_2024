...
struct __attribute__((packed)) TC_main {
  ...
  int8_t
      motor_current;   // positive for normal operation negative for regen [A]
...
const CAN_TxHeaderTypeDef can_tx_header_TS_REAR_SUSPENSION{
    TC_REAR_SUSPENSION_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    TC_REAR_SUSPENSION_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_TS_WHEEL_VELOCITIES{
    TC_WHEEL_VELOCITIES_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    TC_WHEEL_VELOCITIES_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_TS_TEMPERATURES{
    TC_TEMPERATURES_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    TC_TEMPERATURES_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_TS_IMU_GYRO{
    TC_IMU_GYRO_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    TC_IMU_GYRO_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_TS_IMU_ACC{
    TC_IMU_ACC_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    TC_IMU_ACC_CAN_DLC, DISABLE};
