...
const CAN_TxHeaderTypeDef can_tx_header_LAP_TIMER_MAIN{
    LAP_TIMER_MAIN_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    LAP_TIMER_MAIN_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_LAP_TIMER_SECTOR{
    LAP_TIMER_SECTOR_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    LAP_TIMER_SECTOR_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_LAP_TIMER_ACC_TIME{
    LAP_TIMER_ACC_TIME_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    LAP_TIMER_ACC_TIME_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_LAP_TIMER_SKIDPAD_TIME{
    LAP_TIMER_SKIDPAD_TIME_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    LAP_TIMER_SKIDPAD_TIME_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_LAP_TIMER_LAP_TIME{
    LAP_TIMER_LAP_TIME_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    LAP_TIMER_LAP_TIME_CAN_DLC, DISABLE};
