...
const CAN_TxHeaderTypeDef can_tx_header_SF_PASSIVEELEMENTS{
    SF_PASSIVEELEMENTS_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    SF_PASSIVEELEMENTS_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_SF_LEGENDARYDVANDSUPPLY{
    SF_LEGENDARYDVANDSUPPLY_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    SF_LEGENDARYDVANDSUPPLY_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_SF_SUPPLY{
    SF_SUPPLY_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    SF_SUPPLY_CAN_DLC, DISABLE};

const CAN_TxHeaderTypeDef can_tx_header_SF_SAFETY{
    SF_SAFETY_CAN_ID,  0xFFF,  CAN_ID_STD, CAN_RTR_DATA,
    SF_SAFETY_CAN_DLC, DISABLE};
